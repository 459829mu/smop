...
$(function() {
  ...
  function set_settings() {
    ...
    settings.condition_3_likes = [10000,35000,80000,100000,110000,150000,20000]; 
	...
	settings.condition_1_adjusted_likes = [12000,35000,80000,100000,110000,150000,20000]; // 7
